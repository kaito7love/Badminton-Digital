      ...
      <div className="relative z-10 flex h-screen max-w-[1700px] mx-auto overflow-hidden">
        ...
        <main className="content-scroll flex-1 min-w-0 overflow-y-auto p-6 pb-24 md:pb-10 md:p-10">
          {/* Chi nhánh + tài khoản dời từ chân sidebar lên đây — góc trên
              ...
              Từng đổi sang position:absolute để nằm cùng hàng với tiêu đề
              trang, nhưng user xem thực tế rồi chọn giữ lại kiểu tách hàng
              riêng như này — dễ nhìn hơn, không đè lên tiêu đề trang nào có
              hàng tiêu đề dài. Chỉ hiện ở desktop, mobile đã có 2 mục này
